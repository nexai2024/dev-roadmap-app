/**
 * Branded AppSumo webhook: https://protocol100.xyz/v2/webhooks
 * Proxies to Convex HTTP while preserving raw body + HMAC headers.
 */
...
export default async function handler(request: Request): Promise<Response> {
  ...
  try {
    ...
    console.error("[AppSumo proxy] /v2/webhooks:", message);
